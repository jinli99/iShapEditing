...
from neural_field_diffusion.guided_diffusion.normalization import unnormalize
...
def noise2shape(args=None):
    ...
    # np.save('noise1.npy', noise.cpu().numpy())
    sample = sample_fn(
        model,
        shape,  # CONTROL SHAPE HERE
        clip_denoised=args.clip_denoised,
        model_kwargs=model_kwargs,
        save_intermediate=args.save_intermediate,  # Whether to save intermediate noise
        save_timestep_interval=args.save_timestep_interval,
